...
class InputsView(IHPage):
    ...
    def __init__(self, master=None):
        ...
        client_input = IHInput(stack, label="Cliente", helper="Nombre fiscal o fantasia", placeholder="Ingrese un cliente")
        stack.add(client_input)
        ...
        client_input.set_error("Campo requerido")
